...
import { Table, TableContainer, TableHead, TableRow, TableCell, TableBody, Paper, TablePagination, Avatar } from '@mui/material';
                            ...
                            {filteredData
                                .map((beneficiary, index) => (
                                    <TableRow key={beneficiary.id}>
                                        ...
                                        <TableCell><Avatar alt={beneficiary.full_name} src={beneficiary.image} /></TableCell>
                                        <TableCell>{beneficiary.full_name}</TableCell>
                                        <TableCell><div>
                                        </div>{beneficiary.attendance_status === "Present" ?
                                            (<p className='present'>Present <Icon icon="charm:tick" className='present' /> </p>)
                                            :
                                            (<p className='absent'>Absent <Icon icon="charm:cross" className='absent' /> </p>)
                                            }
