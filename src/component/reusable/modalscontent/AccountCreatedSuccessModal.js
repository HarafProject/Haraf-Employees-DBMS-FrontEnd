    ...
    >
      <div className="">
        ...
        <div className="d-flex flex-column align-items-center modal-content">
          ...
          <p className="mt-2 text-center no-network">
            Account Created Successfully
          </p>
          <span className="mt-2 mb-5 text-center">
            Your account has been successfully created, the super admin will
            grant you access in a short while, use the link in the confirmation
            email to login with your email and password
          </span>
