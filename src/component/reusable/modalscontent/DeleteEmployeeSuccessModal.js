        ...
        <div className='modal-screen px-5 py-1 my-3' isOpen={true} onRequestClose={closeModal}>
            <div className="">
                ...
                <div className="d-flex flex-column align-items-center modal-content">
                        ...
                        Are you sure you want to permanently delete Kadwama Lazarus as an employee? This will remove Joseph's as an employee on the LIPWDMS portal</span>
                 

                    <button className="btn modal-button delete-btn my-4" onClick={()=> navigate('/employee-list')}>
                       Delete
                    </button>
                </div>
            </div>
