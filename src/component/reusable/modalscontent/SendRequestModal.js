...
export default function SendRequestModal({
  ...
  useEffect(() => {
    if (actionType === "add") {
      ...
      setModalText(
        "You don't have permission to edit an employees profile, request access from super admin by stating reason for profile edit"
      );
    } else if (actionType === "delete") {
      setModalTitle("Delete employee Request");
      setModalText(
        "You don't have permission to delete an employees, request access from super admin by stating reason to delete employee"
      );
    }
  }, [actionType]);
