...
const ReusableHeader = () => {
  ...
  function logout(params) {
    if (
      !window.confirm(
        "This action will removed all un-sent reports and data. Do you still want to log out?"
      )
    )
      return;
    ...
    <div className="container-fluid header-section px-4 py-2">
      <div className="d-flex align-items-center justify-content-between header-content px-4">
        ...
        >
          ...
          <li>
            {" "}
            <NavLink to="/supervisor/wards" onClick={closeMobileMenu}>
              Take Attendance
            </NavLink>{" "}
          </li>
          <li>
            {" "}
            <NavLink to="/supervisor/profile" onClick={closeMobileMenu}>
              Supervisor's Profile
            </NavLink>{" "}
          </li>
          <li>
            {" "}
            <NavLink to="/supervisor/notification" onClick={closeMobileMenu}>
              Notifications
            </NavLink>{" "}
          </li>
          <li>
            {" "}
            <NavLink to="/supervisor/report-history" onClick={closeMobileMenu}>
              Report History
            </NavLink>{" "}
          </li>
          <li>
            {offline ? (
              <p className="logout-link">Offline</p>
            ) : (
