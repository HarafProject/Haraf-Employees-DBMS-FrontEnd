...
export default function AddEmployeeScreen({ prefilledData }) {
  ...
  useEffect(() => {
    if (!bankDetail.accountNumber)
      toast.info("Please enter bank details before proceeding.");
  ...
  async function verifyBankDetails() {
    ...
    if (bankDetail.bankName === "Select Bank")
      return toast.error("Please select bank.");
    toast.info("Please wait while we verify your bank details.");
    try {
      const { bankDetails, message } =
        await supervisor.verifyEmpoyeeBankAccount(bankDetail);
      ...
      <div className="add-employee-screen mt-5 py-5">
        <div className="d-flex flex-column align-items-center add-employee-content mt-4">
          ...
          <form>
              ...
              <div className="mx-3">
                ...
                <div className="form-field my-4">
                  <select
                    name="workTypology"
                    disabled={!isVerified}
                    {...formik.getFieldProps("workTypology")}
                  >
                ...
                <div className="form-field my-4">
                  <select
                    ...
                    disabled={!isVerified}
                    {...formik.getFieldProps("specialDisability")}
                  >
                ...
                <div className="form-field my-4">
                  <select
                    name="householdHead"
                    disabled={!isVerified}
                    {...formik.getFieldProps("householdHead")}
                  >
            ...
            {isLoading && (
              <center className="btn save-employee mt-5">
