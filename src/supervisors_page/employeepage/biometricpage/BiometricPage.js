        ...
        <div className="biometric-page">
            <ReusableHeader />
                ...
                <div className="biometric-content m-4 p-5">
                    ...
                    <p>Place thumb finger directly on the finger print icon below, rotate finger slowly until it reads 100%</p>
                    ...
                    <button onClick={()=> {navigate("/employee-list"); }} className="btn biometric-btn mt-4">Done</button>
                </div>
            </div>
